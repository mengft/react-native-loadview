 ...
 * @Last Modified time: 2018-09-20 16:18:11
 */
    ...
    render () {
        ...
        return (
            ...
            <View style={[Styles.container, style]}>
                { gif === 'triangles' ?
                    <Image style={{ width: iconSize, height: iconSize }} source={require(`./src/assets/loading-triangles.gif`)} />
                    :
                    <Image style={{ width: iconSize, height: iconSize }} source={require(`./src/assets/loading-spinner.gif`)} />
                }
